...
namespace Prowl.Scribe.Internal {
    ...
    // Font unit type for hinting
    struct FUnit {
        int value;

        public static explicit operator int (FUnit v) => v.value;
        public static explicit operator FUnit (int v) => new FUnit { value = v };
        public static explicit operator float (FUnit v) => v.value;
        public static explicit operator FUnit (float v) => new FUnit { value = (int)v };
    ...
    // Point type for raw TrueType coordinates (font units)
    struct Point {
        public FUnit X;
        public FUnit Y;
    ...
    // Point type for hinting with floating point coordinates
    struct PointF {
        public Vector2 P;
        public PointType Type;
    ...
    // Point type definitions for hinting
    enum PointType {
        OnCurve,
        Quadratic,
        Cubic
    ...
    // Exception for font processing errors
